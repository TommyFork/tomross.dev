...
I started coding in middle school, making [Minecraft](https://www.minecraft.net/) plugins for my friends. That pulled me into Java, then PHP and the web, and by high school I was deep in Node.js. Since then, I’ve built everything from small automations to full-stack web apps to a couple of failed startups, most recently [BrightBook](/work#brightbook): a platform for personalizing lessons to individual students that I took from idea to prototype to pilots in the [Boston Public Schools](https://www.bostonpublicschools.org/).
...
I also love dogs, getting out in nature, and cooking for the people I love. I graduated cum laude from Boston University’s Questrom School of Business, where I concentrated in Business Analytics.
